...
(function() {
  ...
  define(["Console", "Underscore", "services/DiagnosticWordsService", "services/UserService", "services/UserWordStatus", "services/GameWordsService", "services/ChallengeWordsService", "services/GamesService", "services/GamesPlayed"], function(Console, _, dws, us, uws, gws, cws, gs, gp) {
    "use strict";
    ...
    return function() {
      ...
      return angular.module("uspeak.diagnostic.resources", ["ngResource"]).factory("DiagnosticWordsService", dws).factory("GameWordsService", gws).factory("ChallengeWordsService", cws).factory("UserService", us).factory("UserWordStatus", uws).factory("GamesService", gs).factory("GamesPlayed", gp).factory("user", function(UserService) {
        var user;
