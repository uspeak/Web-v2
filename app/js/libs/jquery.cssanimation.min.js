...
true);n.animationName=i;n.keyText=f;n.elapsedTime=u;a.dispatchEvent(n)};b=0;var r=false,t=function(f){r=false;for(b=0;b<k.length&&!r;b++)if(a.style[k[b]+"AnimationName"]!==undefined){a.style[k[b]+"AnimationDuration"]=f.duration;a.style[k[b]+"AnimationTimingFunction"]=f.timingFunction;a.style[k[b]+"AnimationFillMode"]='both';a.style[k[b]+"AnimationIterationCount"]=f.iterationCount;a.style[k[b]+"AnimationName"]=f.name;r=true}};t({name:i,duration:g+"ms",timingFunction:j.easing,iterationCount:j.iterationCount});a.isPlaying=true;(function f(){p=
...
(function($){
	 ...
	 */
	$.fn.cssanimation = function(animation, duration, opts, finish) {
		finish = finish || function() {}
		return this.each(function(index, elem){
			var $elem = $(elem);
			$elem.queue(function() {CSSAnimation.trigger(elem, animation, duration, opts)}).bind('cssAnimationKeyframe', function(event){
    			if(event.originalEvent.keyText=='100%') {
    				 $(this).unbind( event );
    				 finish();
    				 $elem.dequeue();
    			}
